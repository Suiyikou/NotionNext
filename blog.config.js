...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '许穗', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '菜鸡设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kee.so/suiyikou', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '笔记', // 网站关键词 英文逗号隔开
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type_sub_menu:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_SUB_MENU || '二级', // 当type文章类型与此值相同时，为子菜单。
    ...
    summary: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SUMMARY || '预览',
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '超链',
